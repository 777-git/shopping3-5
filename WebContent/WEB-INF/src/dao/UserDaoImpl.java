...
public class UserDaoImpl implements UserDao {
	...
	private static final String INSERT = "INSERT INTO user_account (user_id, user_name, password, postcode, address, email, job, hobby, birthday)"
			+ " VALUES(:userId, :userName, :password, :postCode, :address, :email, :job, :hobby, :birthDay)";
